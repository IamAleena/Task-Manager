...
import loginimage from "../assets/images/tasklogin.webp";
          ...
          {login ? (
            <div className="login-left d-flex flex-column justify-content-center align-items-center w-50">
              ...
              <div className="login-form-box d-flex flex-column align-items-center w-50">
                ...
                <div className="submit-btn" onClick={handleSubmitLogin}>
                  Login
                </div>
              </div>
              <div className="register-link">
                Not a User? <a onClick={handleLogin}>Register</a>
              </div>
            </div>
          ) : (
            <div className="login-left d-flex flex-column justify-content-center align-items-center w-50">
              ...
              <div className="login-form-box d-flex flex-column align-items-center w-50">
                ...
                <div className="submit-btn" onClick={handleSubmitRegister}>
                  Register
                </div>
              </div>
              <div className="register-link">
                Existing User? <a onClick={handleLogin}>Login</a>
              </div>
            </div>
          )}
          {qrcard ? (
            <div className="qr-card">
              <QRCodeGenerator text={qrcodetext} size="200" />
              <div className="qr-text">
                You have Successfully registered<br></br> as an Employee{" "}
              </div>
              <div onClick={handleQrclick} className="qr-btn2">
                Continue to Login
              </div>
            </div>
          ) : (
