          ...
          <div className="input-container">
            ...
            <div className="employee-box">
              <textarea
                ...
                onChange={handleChange}
              />
              <div onClick={HandleopenEmployee} className="add-employee-btn">
                +
              </div>
              {employeebox && (
                <>
                    ...
                    <ul>
                      {data.map((user) => (
                        <li
                          ...
                          key={user.id}
                          style={{
                            display: formData.employees.includes(user.username)
                              ? "none"
                              : "block",
                          }}
                        >
            ...
            <input
              ...
              onChange={handleChange}
            />
            <div onClick={SubmitTask} className="addtask-submit-btn">
              Submit Task
            </div>
          </div>
        </div>
